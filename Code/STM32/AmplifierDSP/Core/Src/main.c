...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  HAL_GPIO_WritePin( DSP_ACTIVE_GPIO_Port, DSP_ACTIVE_Pin, GPIO_PIN_SET );
	  HAL_GPIO_WritePin( GPIOD, DSP_LEFT_Pin|DSP_RIGHT_Pin|DSP_SW_Pin|DSP_ALT_Pin, GPIO_PIN_SET );
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_Init(DSP_ACTIVE_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : DSP_LEFT_Pin DSP_RIGHT_Pin DSP_SW_Pin DSP_ALT_Pin */
  GPIO_InitStruct.Pin = DSP_LEFT_Pin|DSP_RIGHT_Pin|DSP_SW_Pin|DSP_ALT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
